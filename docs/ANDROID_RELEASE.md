...
- `release/milte-1.0.0-5.apk`
- `release/milte-1.0.0-5.aab`
...
$ANDROID_SDK_ROOT/cmdline-tools/latest/bin/apkanalyzer manifest application-id release/milte-1.0.0-5.apk
$ANDROID_SDK_ROOT/cmdline-tools/latest/bin/apkanalyzer manifest permissions release/milte-1.0.0-5.apk
$ANDROID_SDK_ROOT/build-tools/36.0.0/apksigner verify --verbose --print-certs release/milte-1.0.0-5.apk
jarsigner -verify -verbose -certs release/milte-1.0.0-5.aab
$ANDROID_SDK_ROOT/build-tools/36.0.0/zipalign -c -P 16 -v 4 release/milte-1.0.0-5.apk
shasum -a 256 -c release/milte-1.0.0-5.apk.sha256
shasum -a 256 -c release/milte-1.0.0-5.aab.sha256
```
