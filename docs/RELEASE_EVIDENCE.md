...
- Release `1.0.0 (5) — sign-in reliability` uses the frozen English notes and a 100% Alpha closed-test rollout. Publishing overview shows **Changes in review** and **1 change sent for review** while Google's automated quick checks and review run.
