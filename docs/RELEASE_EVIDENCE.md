...
- Release `1.0.0 (7) — new Milte identity` is prepared with the frozen English notes and a 100% Alpha rollout. It is waiting at Play's **Ready to release** preview; saving and submitting it for Google review remains intentionally pending the browser action-time confirmation required for an external release submission.
